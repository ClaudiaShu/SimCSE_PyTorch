...
# Origin args
parser.add_argument("--model_name_or_path", type=str, default="princeton-nlp/sup-simcse-bert-base-uncased",
...
def nlp_eval(args):
    ...
    model_file = "/media/storage/yuxuan/software/SimCSE/runs/Dec11_16-46-58/checkpoint/"
